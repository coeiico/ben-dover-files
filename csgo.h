...
constexpr ptrdiff_t dwEntityList = 0x4DA3F5C;
constexpr ptrdiff_t dwForceAttack = 0x31D54B4;
constexpr ptrdiff_t dwForceAttack2 = 0x31D54C0;
constexpr ptrdiff_t dwForceBackward = 0x31D5508;
constexpr ptrdiff_t dwForceForward = 0x31D5514;
constexpr ptrdiff_t dwForceJump = 0x524DEBC;
constexpr ptrdiff_t dwForceLeft = 0x31D5490;
constexpr ptrdiff_t dwForceRight = 0x31D5484;
constexpr ptrdiff_t dwGameDir = 0x62D7F8;
constexpr ptrdiff_t dwGameRulesProxy = 0x52C119C;
constexpr ptrdiff_t dwGetAllClasses = 0xDB3F9C;
constexpr ptrdiff_t dwGlobalVars = 0x58ECE8;
constexpr ptrdiff_t dwGlowObjectManager = 0x52EC550;
constexpr ptrdiff_t dwInput = 0x51F5540;
constexpr ptrdiff_t dwInterfaceLinkList = 0x946B44;
constexpr ptrdiff_t dwLocalPlayer = 0xD8C2CC;
constexpr ptrdiff_t dwMouseEnable = 0xD91E70;
constexpr ptrdiff_t dwMouseEnablePtr = 0xD91E40;
constexpr ptrdiff_t dwPlayerResource = 0x31D3810;
constexpr ptrdiff_t dwRadarBase = 0x51D8CD4;
constexpr ptrdiff_t dwSensitivity = 0xDA32DC;
constexpr ptrdiff_t dwSensitivityPtr = 0xDA32B0;
constexpr ptrdiff_t dwSetClanTag = 0x8A1B0;
constexpr ptrdiff_t dwViewMatrix = 0x4D95874;
constexpr ptrdiff_t dwWeaponTable = 0x51F6000;
constexpr ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ptrdiff_t dwYawPtr = 0xCDA50002;
constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xD96D70;
constexpr ptrdiff_t dwbSendPackets = 0xD749A;
constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA7050;
constexpr ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ptrdiff_t m_yawClassPtr = 0xD91AD0;
constexpr ptrdiff_t m_pitchClassPtr = 0x51D8F70;
...
constexpr ptrdiff_t find_hud_element = 0x3286E320;
